  ...
  return (
    <>
      <section className={styles.politicasContainer}>
        ...
        <p>
          A sua privacidade é importante para nós. É política do Selic Hoje
          respeitar a sua privacidade em relação a qualquer informação sua que
          possamos coletar no site &nbsp;
          <a href="https://www.selichoje.com">Selic Hoje</a>, e outros sites que
        ...
        <p>
          ...
          informação que o Selic Hoje oferece no site e com caráter enunciativo,
          mas não limitativo:
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            jogos ou azar, qualquer tipo de pornografia ilegal, de apologia ao
            terrorismo ou contra os direitos humanos;
          </li>
          <li>
            Não causar danos aos sistemas físicos (hardwares) e lógicos
            (softwares) do Selic Hoje, de seus fornecedores ou terceiros, para
        ...
        <p>
          ...
          <strong> 23 de novembro de 2021</strong>.
        </p>
      </section>
    </>
  );
