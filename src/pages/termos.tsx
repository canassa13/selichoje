  ...
  return (
    <>
      <section className={styles.termosContainer}>
        <h2>1. Termos</h2>
        <p>
          Ao acessar ao site <a href="https://selichoje.com">Selic Hoje</a>,
        ...
        <p>
          ...
          materiais (informações ou software) no site Selic Hoje , apenas para
        ...
        <p>
          ...
          dessas restrições e poderá ser rescindida por Selic Hoje a qualquer
        ...
        <ol>
          <li>
            Os materiais no site da Selic Hoje são fornecidos como estão. Selic
            Hoje não oferece garantias, expressas ou implícitas, e, por este
          ...
          <li>
            Além disso, o Selic Hoje não garante ou faz qualquer representação
        ...
        <h2>4. Limitações</h2>
        <p>
          Em nenhum caso o Selic Hoje ou seus fornecedores serão responsáveis
          ...
          uso ou da incapacidade de usar os materiais em Selic Hoje, mesmo que
          Selic Hoje ou um representante autorizado da Selic Hoje tenha sido
        ...
        <p>
          Os materiais exibidos no site da Selic Hoje podem incluir erros
          técnicos, tipográficos ou fotográficos. Selic Hoje não garante que
          qualquer material em seu site seja preciso, completo ou atual. Selic
          Hoje pode fazer alterações nos materiais contidos em seu site a
          qualquer momento, sem aviso prévio. No entanto, Selic Hoje não se
          compromete a atualizar os materiais.
        </p>
        <h2>6. Links</h2>
        <p>
          O Selic Hoje não analisou todos os sites vinculados ao seu site e não
          é responsável pelo conteúdo de nenhum site vinculado. A inclusão de
          qualquer link não implica endosso por Selic Hoje do site. O uso de
          qualquer site vinculado é por conta e risco do usuário.
        </p>
        <h3>Modificações</h3>
        <p>
          O Selic Hoje pode revisar estes termos de serviço do site a qualquer
        ...
        <p>
          ...
          leis do Selic Hoje e você se submete irrevogavelmente à jurisdição
